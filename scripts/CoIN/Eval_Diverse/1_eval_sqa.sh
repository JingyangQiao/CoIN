...
python ./instruct/LoRASelect.py --codebook ./instruct/codebooks_Diverse/ --instruct ./playground/Instructions_Diverse/ScienceQA/test.json
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CoIN.model_vqa_science \
        ...
        --question-file ./playground/Instructions_Diverse/ScienceQA/test.json \
