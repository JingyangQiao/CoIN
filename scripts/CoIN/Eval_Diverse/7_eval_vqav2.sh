...
python ./instruct/LoRASelect.py --codebook ./instruct/codebooks_Diverse/ --instruct ./playground/Instructions_Diverse/VQAv2/val.json
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CoIN.model_vqa_cc_instruction \
        ...
        --question-file ./playground/Instructions_Diverse/VQAv2/val.json \
...
python llava/eval/CoIN/eval_vqav2.py --annotation-file ./playground/Instructions_Diverse/VQAv2/val.json --result-file $RESULT_DIR/$STAGE/merge.jsonl --output-dir $RESULT_DIR/$STAGE
