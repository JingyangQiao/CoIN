...
python ./instruct/LoRASelect.py --codebook ./instruct/codebooks_Diverse/ --instruct ./playground/Instructions_Diverse/VizWiz/val.json
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CoIN.model_vizwiz \
        ...
        --question-file ./playground/Instructions_Diverse/VizWiz/val.json \
...
python llava/eval/CoIN/eval_vizwiz.py --annotation-file ./playground/Instructions_Diverse/VizWiz/val.json --result-file $RESULT_DIR/$STAGE/merge.jsonl --output-dir $RESULT_DIR/$STAGE
