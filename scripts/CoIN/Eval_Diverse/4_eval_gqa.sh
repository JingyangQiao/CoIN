...
python ./instruct/LoRASelect.py --codebook ./instruct/codebooks_Diverse/ --instruct ./playground/Instructions_Diverse/GQA/test.json
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CoIN.model_gqa \
        ...
        --question-file ./playground/Instructions_Diverse/GQA/test.json \
