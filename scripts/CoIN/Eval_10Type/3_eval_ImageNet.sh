...
python ./instruct/LoRASelect.py --codebook ./instruct/codebooks_10Type/ --instruct ./playground/Instructions_10Type/ImageNet/test.json
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CoIN.model_vqa_cc_instruction \
        ...
        --question-file ./playground/Instructions_10Type/ImageNet/test.json \
...
python -m llava.eval.CoIN.eval_ImagetNet \
    --test-file ./playground/Instructions_10Type/ImageNet/test.json \
