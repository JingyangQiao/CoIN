...
python ./instruct/LoRASelect.py --codebook ./instruct/codebooks_10Type/ --instruct ./playground/Instructions_10Type/TextVQA/val.json
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CoIN.model_text_vqa \
        ...
        --question-file ./playground/Instructions_10Type/TextVQA/val.json \
