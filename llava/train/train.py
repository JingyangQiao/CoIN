...
from CoIN.peft import PeftModel, TaskType, get_peft_model, LoraConfig, WEIGHTS_NAME, set_peft_model_state_dict
...
def train():
    ...
    training_args.dema = bool(training_args.dema)
